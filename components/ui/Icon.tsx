...
// FIX: Replaced `JSX.Element` with `React.ReactElement` to avoid relying on the global JSX namespace.
const icons: { [key: string]: React.ReactElement } = {
    ...
    'clipboard-document-list': <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" />,
    ...
    'chevron-double-left': <path strokeLinecap="round" strokeLinejoin="round" d="M11 19l-7-7 7-7m8 14l-7-7 7-7" />,
    ...
    'lock-open': <path strokeLinecap="round" strokeLinejoin="round" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />,
...
export const Icon: React.FC<IconProps> = ({ type, className = 'h-6 w-6' }) => {
    return (
        <svg
            ...
            strokeWidth={1.5}
        >
            {icons[type] || <path d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 016-6h6v6z" />}
        </svg>
    );
};